...
const projects = productFeatures
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className={cn("mb-12 sm:mb-16 space-y-4 opacity-0", isVisible && "animate-fade-in-up")}>
          <p className="font-mono text-xs uppercase tracking-[0.25em] sm:tracking-[0.35em] text-primary">
            {siteConfig.sections.features.eyebrow}
          </p>
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl">{siteConfig.sections.features.title}</h1>
          <p className="max-w-2xl text-base sm:text-lg text-muted-foreground leading-relaxed">
            {siteConfig.sections.features.subtitle}
          </p>
        </div>
              ...
              >
                <span
                  className={cn(
                    ...
                    project.status === "live" && "bg-primary shadow-sm shadow-primary/50",
                    project.status === "beta" && "bg-yellow-500 animate-pulse shadow-sm shadow-yellow-500/50",
                    project.status === "planned" && "bg-muted-foreground",
                  )}
                />
                <span className="font-mono text-xs text-muted-foreground">{featureStatusLabels[project.status]}</span>
              </div>
